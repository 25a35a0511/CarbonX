    ...
    <DashboardLayout>
      ...
      <div style={{ display:'grid', gridTemplateColumns:'repeat(4,1fr)', gap:14, marginBottom:22 }}>
        {[
          ...
          { icon:'💹', val:summary.credits>0?fmt(summary.volume/Math.max(summary.credits,1)):'$0', lbl:'Avg Price/Credit', color:'#d97706' },
        ].map((st,i)=>(
      ...
      <div style={{ display:'grid', gridTemplateColumns:'1fr auto', gap:20, marginBottom:22, alignItems:'flex-end' }}>
        {/* Bar chart */}
        ...
        <div style={{ display:'flex', flexDirection:'column', gap:8 }}>
          <input style={{ ...s.search, width:260 }} placeholder="🔍 Search project, buyer, seller…" value={search}
